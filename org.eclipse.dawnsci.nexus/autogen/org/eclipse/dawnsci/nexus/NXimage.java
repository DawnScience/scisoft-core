 ...
 * <p><b>Symbols:</b><ul>
 * <li><b>n_img</b>
 * Number of images in the stack, for stacks the slowest dimension.</li>
 * <li><b>n_m</b>
 * Number of image points along the slowest dimension.</li>
 * <li><b>n_k</b>
 * Number of image points along the slow dimension (k equivalent to z).</li>
 * <li><b>n_j</b>
 * Number of image points along the fast dimension (j equivalent to y).</li>
 * <li><b>n_i</b>
 * Number of image points along the fastest dimension (i equivalent to x).</li></ul></p>
 *
 */
public interface NXimage extends NXobject {
	 ...
	 * <ul>
	 * <li>
	 * Details how NXdata instance were processed from detector readings/raw data.</li>
	 * </ul>
	 *
	 ...
	 * One-dimensional image.
	 *
	 * @param image_1dGroup the image_1dGroup
	 */
	 ...
	 * Two-dimensional image.
	 *
	 * @param image_2dGroup the image_2dGroup
	 */
	 ...
	 * Three-dimensional image.
	 *
	 * @param image_3dGroup the image_3dGroup
	 */
	 ...
	 * Four-dimensional image.
	 *
	 * @param image_4dGroup the image_4dGroup
	 */
	 ...
	 * Collection of one-dimensional images.
	 *
	 * @param stack_1dGroup the stack_1dGroup
	 */
