 ...
 */
public class NXapm_simulationImpl extends NXobjectImpl implements NXapm_simulation {
	...
	public NXapm_simulationImpl() {
		super();
	}

	public NXapm_simulationImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXapm_simulation.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_APM_SIMULATION;
	}
