 ...
 */
public class NXcs_cpuImpl extends NXobjectImpl implements NXcs_cpu {
	...
	public NXcs_cpuImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXcs_cpu.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_CS_CPU;
	}
