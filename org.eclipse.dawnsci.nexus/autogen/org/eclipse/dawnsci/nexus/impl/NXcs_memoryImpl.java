 ...
 */
public class NXcs_memoryImpl extends NXcomponentImpl implements NXcs_memory {
	...
	public NXcs_memoryImpl() {
		super();
	}

	public NXcs_memoryImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXcs_memory.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_CS_MEMORY;
	}
