 ...
 */
public class NXcs_processorImpl extends NXcomponentImpl implements NXcs_processor {
	...
	public NXcs_processorImpl() {
		super();
	}

	public NXcs_processorImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXcs_processor.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_CS_PROCESSOR;
	}
