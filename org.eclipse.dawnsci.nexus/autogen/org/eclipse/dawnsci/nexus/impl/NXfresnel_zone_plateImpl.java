 ...
 */
public class NXfresnel_zone_plateImpl extends NXcomponentImpl implements NXfresnel_zone_plate {
	...
	@Override
	public Dataset getFabricationString() {
		return getDataset(NX_FABRICATION);
	}

	@Override
	public String getFabricationStringScalar() {
		return getString(NX_FABRICATION);
	}

	@Override
	public DataNode setFabricationString(IDataset fabricationDataset) {
		return setDataset(NX_FABRICATION, fabricationDataset);
	}

	@Override
	public DataNode setFabricationStringScalar(String fabricationValue) {
