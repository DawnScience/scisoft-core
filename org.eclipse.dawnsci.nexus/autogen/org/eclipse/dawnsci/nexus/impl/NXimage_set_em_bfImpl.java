 ...
 * 
 */
public class NXimage_set_em_bfImpl extends NXobjectImpl implements NXimage_set_em_bf {
	...
	public NXimage_set_em_bfImpl() {
		super();
	}

	public NXimage_set_em_bfImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_bf.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_BF;
	}
