 ...
 * 
 */
public class NXimage_set_em_bseImpl extends NXobjectImpl implements NXimage_set_em_bse {
	...
	public NXimage_set_em_bseImpl() {
		super();
	}

	public NXimage_set_em_bseImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_bse.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_BSE;
	}
