 ...
 * 
 */
public class NXimage_set_em_chamberImpl extends NXobjectImpl implements NXimage_set_em_chamber {
	...
	public NXimage_set_em_chamberImpl() {
		super();
	}

	public NXimage_set_em_chamberImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_chamber.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_CHAMBER;
	}
