 ...
 * 
 */
public class NXimage_set_em_dfImpl extends NXobjectImpl implements NXimage_set_em_df {
	...
	public NXimage_set_em_dfImpl() {
		super();
	}

	public NXimage_set_em_dfImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_df.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_DF;
	}
