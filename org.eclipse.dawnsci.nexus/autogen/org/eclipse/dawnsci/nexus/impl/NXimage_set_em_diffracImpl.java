 ...
 * 
 */
public class NXimage_set_em_diffracImpl extends NXobjectImpl implements NXimage_set_em_diffrac {
	...
	public NXimage_set_em_diffracImpl() {
		super();
	}

	public NXimage_set_em_diffracImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_diffrac.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_DIFFRAC;
	}
