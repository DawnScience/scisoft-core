 ...
 * 
 */
public class NXimage_set_em_ecciImpl extends NXobjectImpl implements NXimage_set_em_ecci {
	...
	public NXimage_set_em_ecciImpl() {
		super();
	}

	public NXimage_set_em_ecciImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_ecci.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_ECCI;
	}
