 ...
 * 
 */
public class NXimage_set_em_ronchigramImpl extends NXobjectImpl implements NXimage_set_em_ronchigram {
	...
	public NXimage_set_em_ronchigramImpl() {
		super();
	}

	public NXimage_set_em_ronchigramImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXimage_set_em_ronchigram.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_IMAGE_SET_EM_RONCHIGRAM;
	}
