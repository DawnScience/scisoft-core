 ...
 */
public class NXoptical_fiberImpl extends NXcomponentImpl implements NXoptical_fiber {
	...
	public NXoptical_fiberImpl() {
		super();
	}

	public NXoptical_fiberImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXoptical_fiber.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_OPTICAL_FIBER;
	}
