 ...
 */
public class NXoptical_polarizerImpl extends NXcomponentImpl implements NXoptical_polarizer {
	...
	public NXoptical_polarizerImpl() {
		super();
	}

	public NXoptical_polarizerImpl(final long oid) {
		super(oid);
	}

	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXoptical_polarizer.class;
	}

	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_OPTICAL_POLARIZER;
	}
	...
	@Override
	public NXsample getCoatingtype() {
		// dataNodeName = NX_COATINGTYPE
		return getChild("coatingtype", NXsample.class);
	}

	@Override
	public void setCoatingtype(NXsample coatingtypeGroup) {
		putChild("coatingtype", coatingtypeGroup);
	}
