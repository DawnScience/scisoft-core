 ...
 * 
 */
public class NXspectrum_set_em_augerImpl extends NXobjectImpl implements NXspectrum_set_em_auger {
	...
	public NXspectrum_set_em_augerImpl() {
		super();
	}

	public NXspectrum_set_em_augerImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXspectrum_set_em_auger.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_SPECTRUM_SET_EM_AUGER;
	}
