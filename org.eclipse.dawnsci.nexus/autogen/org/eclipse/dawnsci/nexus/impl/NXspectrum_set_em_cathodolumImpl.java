 ...
 * 
 */
public class NXspectrum_set_em_cathodolumImpl extends NXobjectImpl implements NXspectrum_set_em_cathodolum {
	...
	public NXspectrum_set_em_cathodolumImpl() {
		super();
	}

	public NXspectrum_set_em_cathodolumImpl(final long oid) {
		super(oid);
	}
	
	@Override
	public Class<? extends NXobject> getNXclass() {
		return NXspectrum_set_em_cathodolum.class;
	}
	
	@Override
	public NexusBaseClass getNexusBaseClass() {
		return NexusBaseClass.NX_SPECTRUM_SET_EM_CATHODOLUM;
	}
