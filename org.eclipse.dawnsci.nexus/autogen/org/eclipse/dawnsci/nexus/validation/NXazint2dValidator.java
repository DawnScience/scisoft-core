 ...
 */
public class NXazint2dValidator extends AbstractNexusValidator implements NexusApplicationValidator {

	public NXazint2dValidator() {
		super(NexusApplicationDefinition.NX_AZINT2D);
	}
	...
	private void validateGroup_NXentry_NXdata(final NXdata group) {
		...
		if (I != null) {
			...
			validateFieldRank("I", I, 3);
			validateFieldDimensions("I", I, null, "nImg", "nEta", "nRad");
		...
		final ILazyDataset I_errors = group.getLazyDataset("I_errors");
			...
			validateFieldRank("I_errors", I_errors, 3);
			validateFieldDimensions("I_errors", I_errors, null, "nImg", "nEta", "nRad");
		...
		final ILazyDataset norm = group.getLazyDataset("norm");
			...
			validateFieldRank("norm", norm, 2);
			validateFieldDimensions("norm", norm, null, "nEta", "nRad");
		...
		// validate optional field 'azimuthal_axis' of type NX_NUMBER. Note: field not defined in base class.
		final ILazyDataset azimuthal_axis = group.getLazyDataset("azimuthal_axis");
				if (azimuthal_axis != null) {
			// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
			validateFieldType("azimuthal_axis", azimuthal_axis, NX_NUMBER);
			validateFieldRank("azimuthal_axis", azimuthal_axis, 1);
			validateFieldDimensions("azimuthal_axis", azimuthal_axis, null, "nEta");
		// validate attribute 'long_name' of field 'azimuthal_axis' of type NX_CHAR.
		final Attribute azimuthal_axis_attr_long_name = group.getDataNode("azimuthal_axis").getAttribute("long_name");
		if (!(validateAttributeNotNull("long_name", azimuthal_axis_attr_long_name))) return;
		// validate any properties of this attribute specified in the NXDL file: type, enumeration
		validateAttributeType("long_name", azimuthal_axis_attr_long_name, NX_CHAR);
		validateAttributeEnumeration("long_name", azimuthal_axis_attr_long_name,
				"azimuthal bin center");

		// validate attribute 'units' of field 'azimuthal_axis' of type NX_CHAR.
		final Attribute azimuthal_axis_attr_units = group.getDataNode("azimuthal_axis").getAttribute("units");
		if (!(validateAttributeNotNull("units", azimuthal_axis_attr_units))) return;
		// validate any properties of this attribute specified in the NXDL file: type, enumeration
		validateAttributeType("units", azimuthal_axis_attr_units, NX_CHAR);
		validateAttributeEnumeration("units", azimuthal_axis_attr_units,
				"NX_ANGLE");

		}

		// validate optional field 'azimuthal_axis_edges' of type NX_NUMBER. Note: field not defined in base class.
		final ILazyDataset azimuthal_axis_edges = group.getLazyDataset("azimuthal_axis_edges");
				if (azimuthal_axis_edges != null) {
			// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
			validateFieldType("azimuthal_axis_edges", azimuthal_axis_edges, NX_NUMBER);
			validateFieldRank("azimuthal_axis_edges", azimuthal_axis_edges, 1);
			validateFieldDimensions("azimuthal_axis_edges", azimuthal_axis_edges, null, "nEtaEdge");
		// validate attribute 'long_name' of field 'azimuthal_axis_edges' of type NX_CHAR.
		final Attribute azimuthal_axis_edges_attr_long_name = group.getDataNode("azimuthal_axis_edges").getAttribute("long_name");
		if (!(validateAttributeNotNull("long_name", azimuthal_axis_edges_attr_long_name))) return;
		// validate any properties of this attribute specified in the NXDL file: type, enumeration
		validateAttributeType("long_name", azimuthal_axis_edges_attr_long_name, NX_CHAR);
		validateAttributeEnumeration("long_name", azimuthal_axis_edges_attr_long_name,
				"azimuthal bin edges");

		// validate attribute 'units' of field 'azimuthal_axis_edges' of type NX_CHAR.
		final Attribute azimuthal_axis_edges_attr_units = group.getDataNode("azimuthal_axis_edges").getAttribute("units");
		if (!(validateAttributeNotNull("units", azimuthal_axis_edges_attr_units))) return;
		// validate any properties of this attribute specified in the NXDL file: type, enumeration
		validateAttributeType("units", azimuthal_axis_edges_attr_units, NX_CHAR);
		validateAttributeEnumeration("units", azimuthal_axis_edges_attr_units,
				"NX_ANGLE");
