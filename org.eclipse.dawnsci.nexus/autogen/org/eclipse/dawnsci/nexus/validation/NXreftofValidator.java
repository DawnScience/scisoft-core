...
public class NXreftofValidator extends AbstractNexusValidator implements NexusApplicationValidator {
	...
	private void validateGroup_NXentry_instrument(final NXinstrument group) {
		...
		validateGroup_NXentry_instrument_chopper(group.getDisk_chopper("chopper"));
	 ...
	 */
	private void validateGroup_NXentry_instrument_chopper(final NXdisk_chopper group) {
		// validate that the group is not null
