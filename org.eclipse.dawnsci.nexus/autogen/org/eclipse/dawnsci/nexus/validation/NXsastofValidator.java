 ...
 */
public class NXsastofValidator extends AbstractNexusValidator implements NexusApplicationValidator {

	public NXsastofValidator() {
		super(NexusApplicationDefinition.NX_SASTOF);
	}
	...
	private void validateGroup_NXentry_instrument_collimator_geometry_shape(final NXshape group) {
		...
		if (!(validateFieldNotNull("size", size))) return;
		// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
	...
	private void validateGroup_NXentry_instrument_detector(final NXdetector group) {
		...
		if (!(validateFieldNotNull("aequatorial_angle", aequatorial_angle))) return;
		// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
