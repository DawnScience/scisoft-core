 ...
 */
public class NXsnshistoValidator extends AbstractNexusValidator implements NexusApplicationValidator {

	public NXsnshistoValidator() {
		super(NexusApplicationDefinition.NX_SNSHISTO);
	}
	...
	private void validateGroup_NXentry_NXdata(final NXdata group) {
		...
		// validate link 'data_x_time_of_flight' to location '/NXentry/NXinstrument/NXdetector/data_x_time_of_flight
		final DataNode data_x_time_of_flight = group.getDataNode("data_x_time_of_flight");
		validateDataNodeLink("data_x_time_of_flight", data_x_time_of_flight, "/NXentry/NXinstrument/NXdetector/data_x_time_of_flight");
		...
		// validate link 'data_y_time_of_flight' to location '/NXentry/NXinstrument/NXdetector/data_y_time_of_flight
		final DataNode data_y_time_of_flight = group.getDataNode("data_y_time_of_flight");
		validateDataNodeLink("data_y_time_of_flight", data_y_time_of_flight, "/NXentry/NXinstrument/NXdetector/data_y_time_of_flight");

		// validate link 'pixel_id' to location '/NXentry/NXinstrument/NXdetector/pixel_id
		final DataNode pixel_id = group.getDataNode("pixel_id");
		validateDataNodeLink("pixel_id", pixel_id, "/NXentry/NXinstrument/NXdetector/pixel_id");
		...
		// validate link 'total_counts' to location '/NXentry/NXinstrument/NXdetector/total_counts
		final DataNode total_counts = group.getDataNode("total_counts");
		validateDataNodeLink("total_counts", total_counts, "/NXentry/NXinstrument/NXdetector/total_counts");
	...
	private void validateGroup_NXentry_instrument(final NXinstrument group) {
		...
		for (final NXfermi_chopper fermi_chopper : allFermi_chopper.values()) {
			validateGroup_NXentry_instrument_NXfermi_chopper(fermi_chopper);
		}
	...
	private void validateGroup_NXentry_instrument_NXdetector(final NXdetector group) {
		...
		if (data != null) {
			...
			validateFieldDimensions("data", data, null, "numx", "numy", "numtof");
		}

		// validate field 'data_x_time_of_flight' of type NX_UINT. Note: field not defined in base class.
		final ILazyDataset data_x_time_of_flight = group.getLazyDataset("data_x_time_of_flight");
		validateFieldNotNull("data_x_time_of_flight", data_x_time_of_flight);
		if (data_x_time_of_flight != null) {
			// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
			validateFieldType("data_x_time_of_flight", data_x_time_of_flight, NX_UINT);
			validateFieldRank("data_x_time_of_flight", data_x_time_of_flight, 2);
			validateFieldDimensions("data_x_time_of_flight", data_x_time_of_flight, null, "numx", "numtof");
		}
		...
		// validate field 'data_y_time_of_flight' of type NX_UINT. Note: field not defined in base class.
		final ILazyDataset data_y_time_of_flight = group.getLazyDataset("data_y_time_of_flight");
		validateFieldNotNull("data_y_time_of_flight", data_y_time_of_flight);
		if (data_y_time_of_flight != null) {
			// validate any properties of this field specified in the NXDL file: type, units, enumeration, dimensions
			validateFieldType("data_y_time_of_flight", data_y_time_of_flight, NX_UINT);
			validateFieldRank("data_y_time_of_flight", data_y_time_of_flight, 2);
			validateFieldDimensions("data_y_time_of_flight", data_y_time_of_flight, null, "numy", "numtof");
		}
		...
		if (time_of_flight != null) {
			...
			validateFieldDimensions("time_of_flight", time_of_flight, null, "numtof + 1");
		}
	...
	/**
	 * Validate optional unnamed group of type NXfermi_chopper.
	 */
	private void validateGroup_NXentry_instrument_NXfermi_chopper(final NXfermi_chopper group) {
		// validate that the group is not null
