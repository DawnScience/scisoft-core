...
public class NXtofnpdValidator extends AbstractNexusValidator implements NexusApplicationValidator {
	...
	public NXtofnpdValidator() {
		super(NexusApplicationDefinition.NX_TOFNPD);
	}
	...
	private void validateGroup_NXentry_NXinstrument(final NXinstrument group) {
		...
		validateGroup_NXentry_NXinstrument_detector(group.getDetector());
	}

	/**
	 * Validate group 'detector' of type NXdetector.
	 */
	private void validateGroup_NXentry_NXinstrument_detector(final NXdetector group) {
		// validate that the group is not null
		...
		final ILazyDataset detector_number = group.getLazyDataset("detector_number");
