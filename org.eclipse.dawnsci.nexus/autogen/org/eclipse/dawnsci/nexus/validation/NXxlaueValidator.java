...
public class NXxlaueValidator extends AbstractNexusValidator implements NexusApplicationValidator {
	...
	private void validateGroup_NXentry_instrument_source(final NXsource group) {
		...
		validateGroup_NXentry_instrument_source_distribution(group.getDistribution());
	}

	/**
	 * Validate group 'distribution' of type NXdata.
	 */
	private void validateGroup_NXentry_instrument_source_distribution(final NXdata group) {
		// validate that the group is not null
