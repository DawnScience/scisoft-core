...
public interface CompoundDataset extends Dataset {
	...
	@Override
	public CompoundDataset getSlice(SliceIterator iterator);
	...
	@Override
	public CompoundDataset put(int[] indices, Object[] values);
	...
	@Override
	public CompoundDataset take(int[] indices, Integer axis);
