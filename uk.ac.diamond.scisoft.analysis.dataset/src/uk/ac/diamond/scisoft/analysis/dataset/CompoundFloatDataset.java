...
public class CompoundFloatDataset extends AbstractCompoundDataset {
	 ...
	 */
	protected static final Logger compoundLogger = LoggerFactory.getLogger(CompoundFloatDataset.class);
	 ...
	 * @param datasets
	 */
	public CompoundFloatDataset(final ADataset... datasets) {
	 ...
	 * @param dataset
	 */
	public CompoundFloatDataset(final int itemSize, final boolean repeat, final ADataset dataset) {
		isize = itemSize;
	...
	public Object getObject(final int i) {
		return getFloatArray(i); // CLASS_TYPE
	}

	@Override
	public Object getObject(final int i, final int j) {
		return getFloatArray(i, j); // CLASS_TYPE
	}
	 ...
	 */
	public float[] getFloatArray(final int i) { // CLASS_TYPE // PRIM_TYPE
		return (float[]) getObjectAbs(get1DIndex(i)); // PRIM_TYPE
	}
	 ...
	 * @return item in given position
	 */
	public float[] getFloatArray(final int i, final int j) { // CLASS_TYPE // PRIM_TYPE
		return (float[]) getObjectAbs(get1DIndex(i, j)); // PRIM_TYPE
	}
	...
	@Override
	public CompoundFloatDataset setByBoolean(final Object o, ADataset selection) {
	...
	@Override
	public CompoundFloatDataset setByIndex(final Object o, ADataset index) {
		if (o instanceof ADataset) {
			ADataset ds = (ADataset) o;
	...
	@Override
	public CompoundFloatDataset setByIndexes(final Object o, final Object... index) {
