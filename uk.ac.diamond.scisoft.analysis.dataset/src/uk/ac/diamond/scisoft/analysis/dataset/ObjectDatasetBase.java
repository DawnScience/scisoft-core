...
public class ObjectDatasetBase extends AbstractDataset {
	...
	@Override
	public ObjectDatasetBase setByBoolean(final Object obj, ADataset selection) {
	...
	@Override
	public ObjectDatasetBase setByIndex(final Object obj, final ADataset index) {
		if (obj instanceof ADataset) {
			final ADataset ds = (ADataset) obj;
	...
	@Override
	public ObjectDatasetBase setByIndexes(final Object obj, final Object... index) {
