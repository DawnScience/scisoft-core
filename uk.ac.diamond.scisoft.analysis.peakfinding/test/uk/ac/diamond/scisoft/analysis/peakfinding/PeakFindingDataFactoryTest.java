...
public class PeakFindingDataFactoryTest {
	...
	public void createPeakFindingData() {
		List<String> activePFs = new ArrayList<String>();
		activePFs.add(dummyID);
		
		Integer nPeaks = DummyPeakFinder.getFakePeaks().size();
		
		IDataset xData = DatasetFactory.createRange(0, 10, 1, Dataset.FLOAT32);
		IDataset yData = DatasetFactory.createRange(0, 10, 1, Dataset.FLOAT32);
	...
	public void createPSet() throws Exception {
		...
		Map<String, IPeakFinderParameter> pSet = PeakFindingDataFactory.createParameterSet(dummyID, vals);
	...
	public void createPSetDiffLengthsException() throws Exception {
		...
		PeakFindingDataFactory.createParameterSet(peakFindServ, dummyID, vals);
	}
