...
public class ExampleDataUtils {
	...
	public static String createExampleDataFile(String name, int[] shape) {
		...
		try {
			...
			file.addAttribute(entryGroup, TreeFactory.createAttribute(NexusConstants.NXCLASS, NexusConstants.ENTRY));
			...
			for (int i = 0; i < shape.length; i++) {
				...
				file.addAttribute(dataNode, TreeFactory.createAttribute(NexusConstants.DATA_AXIS, i+1));
			}
