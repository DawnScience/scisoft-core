...
public class DivideInternalFrameOperation extends AbstractInternalFrameOperation {

	@Override
	public String getId() {
        return "uk.ac.diamond.scisoft.analysis.processing.operations.internaldata.DivideInternalFrameOperation";
	}
