...
public class DivideScalarOperation extends AbstractScalarMathsOperation<ScalarModel> {

	@Override
	public String getId() {
		return "uk.ac.diamond.scisoft.analysis.processing.scalar.DivideScalarOperation";
	}
