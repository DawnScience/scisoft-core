...
public class BoxSlicer {
	...
	public static IDataset iBelowOrRightBox (IDataset input , IMonitor monitor, 
			RectangularROI roi, int boundaryBox, Direction direction) {
		return iBelowOrRightBox(input, monitor, roi.getIntLengths(), roi.getIntPoint(), boundaryBox, direction);
	}
}
