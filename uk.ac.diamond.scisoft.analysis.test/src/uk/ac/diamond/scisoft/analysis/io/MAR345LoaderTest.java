...
public class MAR345LoaderTest {
	...
	private void checkImage(IDataset image) {
		...
		Assert.assertEquals(627, image.getInt(3449, 3449));
		...
		Assert.assertEquals(1054, image.getInt(641, 1738));
		Assert.assertEquals(142, image.getInt(748, 589));
		Assert.assertEquals(936, image.getInt(854, 2890));
		Assert.assertEquals(279, image.getInt(961, 1741));
