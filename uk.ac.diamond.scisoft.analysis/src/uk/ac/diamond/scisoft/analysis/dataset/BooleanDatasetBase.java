...
public class BooleanDatasetBase extends AbstractDataset {
	 ...
	 * @param wrap
	 */
	public BooleanDatasetBase(final BooleanDatasetBase dataset, final boolean wrap) {
		if (wrap) {
	...
	public String getStringAbs(final int index) {
		return String.format("%b", data[index]); // FORMAT_STRING
	}
	...
	@Override
	public BooleanDatasetBase setByBoolean(final Object obj, BooleanDataset selection) {
	...
	@Override
	public BooleanDatasetBase setByIndex(final Object obj, final IntegerDataset index) {
		if (obj instanceof AbstractDataset) {
			final AbstractDataset ds = (AbstractDataset) obj;
	...
	@Override
	public BooleanDatasetBase setByIndexes(final Object obj, final Object... index) {
	...
	private List<Integer> findPositions(final boolean value) { // PRIM_TYPE
		IndexIterator iter = getIterator();
