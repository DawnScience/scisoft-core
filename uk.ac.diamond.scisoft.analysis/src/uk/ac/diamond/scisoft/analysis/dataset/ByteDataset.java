...
public class ByteDataset extends AbstractDataset {
	 ...
	 */
	transient private static final Logger logger = LoggerFactory.getLogger(ByteDataset.class);
	...
	private static byte[] createArray(final int size) { // PRIM_TYPE
	...
	@Override
	public ByteDataset setByBoolean(final Object obj, BooleanDataset selection) {
	...
	@Override
	public ByteDataset setByIndex(final Object obj, IntegerDataset index) {
		if (obj instanceof AbstractDataset) {
			final AbstractDataset ds = (AbstractDataset) obj;
	...
	private List<Integer> findPositions(final byte value) { // PRIM_TYPE
		IndexIterator iter = getIterator();
	...
	public int[] maxPos(boolean ignoreNaNs) {
		...
		if (o == null) {
			max = findPositions(((Number) getMaxMin(ignoreNaNs, storeName(ignoreNaNs, "max"))).byteValue()); // PRIM_TYPE
	...
	public int[] minPos(boolean ignoreNaNs) {
		...
		if (o == null) {
			min = findPositions(((Number) getMaxMin(ignoreNaNs, storeName(ignoreNaNs, "min"))).byteValue()); // PRIM_TYPE
