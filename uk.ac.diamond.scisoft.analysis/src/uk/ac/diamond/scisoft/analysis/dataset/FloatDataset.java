...
public class FloatDataset extends AbstractDataset {
	 ...
	 * @param wrap
	 */
	public FloatDataset(final FloatDataset dataset, final boolean wrap) {
		if (wrap) {
	...
	@Override
	public FloatDataset setByBoolean(final Object obj, BooleanDataset selection) {
	...
	@Override
	public FloatDataset setByIndex(final Object obj, final IntegerDataset index) {
		if (obj instanceof AbstractDataset) {
			final AbstractDataset ds = (AbstractDataset) obj;
	...
	public int[] maxPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			max = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MAX)).floatValue()); // PRIM_TYPE
	...
	public int[] minPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			min = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MIN)).floatValue()); // PRIM_TYPE
