...
public class FloatDataset extends AbstractDataset {
	...
	private static float[] createArray(final int size) { // PRIM_TYPE
	...
	public Object getObject(final int... pos) {
		return new Float(get(pos)); // CLASS_TYPE
	}
	...
	@Override
	public FloatDataset setSlice(final Object obj, final int[] start, final int[] stop, final int[] step) {
		SliceIterator siter;
		if (obj instanceof AbstractDataset) {
