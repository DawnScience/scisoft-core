...
public class LongDataset extends AbstractDataset {
	...
	public int[] maxPos(boolean ignoreNaNs) {
		...
		if (o == null) {
			max = findPositions(((Number) getMaxMin(ignoreNaNs, storeName(ignoreNaNs, "max"))).longValue()); // PRIM_TYPE
	...
	public int[] minPos(boolean ignoreNaNs) {
		...
		if (o == null) {
			min = findPositions(((Number) getMaxMin(ignoreNaNs, storeName(ignoreNaNs, "min"))).longValue()); // PRIM_TYPE
