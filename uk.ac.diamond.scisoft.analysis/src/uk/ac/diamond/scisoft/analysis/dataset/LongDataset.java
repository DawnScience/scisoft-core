...
public class LongDataset extends AbstractDataset {
	...
	@Override
	public LongDataset setByBoolean(final Object obj, ADataset selection) {
	...
	@Override
	public LongDataset setByIndex(final Object obj, final ADataset index) {
		if (obj instanceof ADataset) {
			final ADataset ds = (ADataset) obj;
	...
	@Override
	public LongDataset setByIndexes(final Object obj, final Object... index) {
	...
	public int[] maxPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			max = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MAX)).longValue()); // PRIM_TYPE
	...
	public int[] minPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			min = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MIN)).longValue()); // PRIM_TYPE
