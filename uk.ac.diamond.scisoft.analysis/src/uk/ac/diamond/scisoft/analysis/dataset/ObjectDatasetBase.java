...
public class ObjectDatasetBase extends AbstractDataset {
	...
	@Override
	public ObjectDatasetBase setSlice(final Object obj, final int[] start, final int[] stop, final int[] step) {
		SliceIterator siter;
		if (obj instanceof AbstractDataset) {
			...
			while (siter.hasNext() && oiter.hasNext())
				data[siter.index] = ds.getObjectAbs(oiter.index); // GET_ELEMENT_WITH_CAST
		} else {
			try {
