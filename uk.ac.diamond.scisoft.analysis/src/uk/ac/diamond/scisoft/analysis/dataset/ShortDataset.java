...
public class ShortDataset extends AbstractDataset {
	...
	@Override
	public ShortDataset setByBoolean(final Object obj, ADataset selection) {
	...
	@Override
	public ShortDataset setByIndex(final Object obj, final ADataset index) {
		if (obj instanceof ADataset) {
			final ADataset ds = (ADataset) obj;
	...
	public int[] maxPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			max = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MAX)).shortValue()); // PRIM_TYPE
	...
	public int[] minPos(boolean ignoreInvalids) {
		...
		if (o == null) {
			...
			min = findPositions(((Number) getMaxMin(ignoreInvalids, ignoreInvalids, STORE_MIN)).shortValue()); // PRIM_TYPE
