...
/**
 * Created by IntelliJ IDEA. User: Aviad Segev Date: 22/11/2009 Time: 20:29:56 BoundingBox represents a horizontal
 * bounding rectangle defined by its lower left and upper right point. This is usually used as a rough approximation of
...
public class BoundingBox {
	...
	/**
	 * Makes this BoundingBox a "null" envelope, that is, the envelope of the empty geometry.
	 */
	 ...
	 * 
	 * @return true if this BoundingBox is uninitialized or is the envelope of the empty geometry.
	 */
