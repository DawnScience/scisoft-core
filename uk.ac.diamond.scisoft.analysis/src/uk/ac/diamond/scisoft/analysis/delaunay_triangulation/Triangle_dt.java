...
public class Triangle_dt {
	...
	/**
	 * @return The bounding rectange between the minimum and maximum coordinates of the triangle
	 */
	 ...
	 * @return The neighbors that shares the given corner and is not the previous triangle. By: Eyal Roth & Doron Ganel.
	 */
	...
	Circle_dt circumcircle() {
		...
		if (den == 0) // oops, degenerate case
			...
			Point_dt cen = new Point_dt((u * (b.y - c.y) - v * (a.y - b.y)) / den, (v * (a.x - b.x) - u * (b.x - c.x))
					/ den);
	 ...
	 * @param p
	 *            The given point.
	 * @return True iff the given point is a corner of this triangle. By Eyal Roth & Doron Ganel.
	 */
	...
	/**
	 * compute the Z value for the X,Y values of q. assume this triangle represent a plane --> q does NOT need to be
