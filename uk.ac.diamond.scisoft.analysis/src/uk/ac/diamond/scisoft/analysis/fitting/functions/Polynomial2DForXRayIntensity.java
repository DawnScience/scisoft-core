...
public class Polynomial2DForXRayIntensity extends AFunction {
	 ...
	 */
	public Polynomial2DForXRayIntensity() {
		this(0);
	}
	 ...
	 * @param params
	 */
	public Polynomial2DForXRayIntensity(double[] params) {
		super(params);
	}
	 ...
	 * @param params
	 */
	public Polynomial2DForXRayIntensity(IParameter... params) {
		super(params);
	}
	 ...
	 *            maximum boundaries
	 */
	public Polynomial2DForXRayIntensity(double[] min, double[] max) {
		super(0);
