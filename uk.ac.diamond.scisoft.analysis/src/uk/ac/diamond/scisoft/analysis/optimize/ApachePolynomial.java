...
public class ApachePolynomial {
	 ...
	 */
	public AbstractDataset getPolynomialSmoothed(final AbstractDataset x, final AbstractDataset y,int windowSize, int polyOrder) throws OptimizationException{
