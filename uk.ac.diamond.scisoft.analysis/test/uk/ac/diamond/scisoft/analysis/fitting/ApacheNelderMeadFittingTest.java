...
public class ApacheNelderMeadFittingTest {
	...
	public static void doFitting() {
		fittedGaussian = Generic1DFitter.fitPeaks(xAxis, gaussian, new Gaussian(1, 1, 1, 1), new ApacheNelderMead(),
				smoothing, numPeaks);
		fittedLorenzian = Generic1DFitter.fitPeaks(xAxis, lorentzian, new Lorentzian(1, 1, 1, 1),
				new ApacheNelderMead(), smoothing, numPeaks);
		fittedPearsonVII = Generic1DFitter.fitPeaks(xAxis, pearsonVII, new PearsonVII(1, 1, 1, 1),
				new ApacheNelderMead(), smoothing, numPeaks);
		fittedPseudoVoigt = Generic1DFitter.fitPeaks(xAxis, pseudoVoigt, new PearsonVII(1, 1, 1, 1),
				new ApacheNelderMead(), smoothing, numPeaks);
	}
