...
if os.name != 'java':
    ...
    class Test(unittest.TestCase):
        ...
        def testGuiBean_PLOTIDAsString(self):
            ...
            _input = dnp.plot.bean()
            _input[dnp.plot.parameters.plotid] = "93dfd804-85ba-4074-afce-d621f7f2aac6"

            self._flattenAndUnflatten(_input, expected);
        ...
        def testGuiBean_PLOTMODEAsString(self):
            ...
            _input = dnp.plot.bean()
            _input[dnp.plot.parameters.plotmode] = str(dnp.plot.plotmode.multi2d)
        ...
        def testGuiBean_keysAsString(self):
            ...
            _input = dnp.plot.bean()
            _input[str(dnp.plot.parameters.plotmode)] = dnp.plot.plotmode.multi2d
            _input["Title"] = "My amazing plot"
