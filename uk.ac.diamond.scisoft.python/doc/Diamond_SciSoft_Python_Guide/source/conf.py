...
conf_common_path = os.path.join(os.environ['BUILDERS_DOCUMENTATION'], 'common', 'conf_common.py')
...
copyright = u'2011-6, Diamond Light Source'
...
# documentation.
# html_theme_options = [u'haiku']
html_theme = u'classic'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = 'images/diamond-logo.png'
