...
def getPlottingSystem(plottingSystemName):
    ...
    _py4j.java_import(jvm, 'org.eclipse.dawnsci.plotting.api.*')
...
def createColor(r, g, b):
    ...
    '''
    jvm = _py4j.get_gateway().jvm
    _py4j.java_import(jvm, 'org.eclipse.swt.graphics.*')
...
def createHistogramBound(position, rgb):
    ...
    '''
    jvm = _py4j.get_gateway().jvm
    _py4j.java_import(jvm, 'org.eclipse.dawnsci.plotting.api.histogram.*')
...
def getService(serviceClass):
    ...
    '''
    jvm = _py4j.get_gateway().jvm
    _py4j.java_import(jvm, 'org.dawb.common.services.*')
