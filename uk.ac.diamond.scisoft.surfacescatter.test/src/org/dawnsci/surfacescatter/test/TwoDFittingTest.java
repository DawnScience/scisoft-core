...
//		model.setBox(box);
//		model.setBoundaryBox(40);
//		model.setFitPower(FitPower.TWO);
//		model.setLenPt(lenPt);
//
...
//		
//		ILazyDataset ild = mainSignal;
//		ILazyDataset[] images = new ILazyDataset[1];
//		images[0] = ild;
//// 		sm.setImages(images);;
//		
...
//		
//		Dataset output = TwoDFitting.TwoDFitting1(testGeneratedImage, model, sm, 0);
//		
