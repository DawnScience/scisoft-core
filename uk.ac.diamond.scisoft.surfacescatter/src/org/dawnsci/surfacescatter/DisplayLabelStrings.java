...
public class DisplayLabelStrings {

	private static final String TURN_TRACKER_ON = "Turn Tracker On";
	private static final String TURN_TRACKER_OFF = "Turn Tracker Off";
	...
	public static String getTurnTrackerOn() {
		return TURN_TRACKER_ON;
	}
	public static String getTurnTrackerOff() {
		return TURN_TRACKER_OFF;
	}
	public static String getBgSubtractedImage() {
