...
//		beamfootprint.cumulativeProbability((footprint*Math.sin((theta + angularfudgefactor)*Math.PI/180))/2
		...
		System.out.println("beamfootprint.cumulativeProbability((footprint*Math.sin((theta + angularfudgefactor)*Math.PI/180))/2)"+ beamfootprint.cumulativeProbability((footprint*Math.sin((theta + angularfudgefactor)*Math.PI/180))/2));
		
		System.out.println("(footprint*Math.sin((theta + angularfudgefactor)*Math.PI/180)   :    " + (footprint*Math.sin((theta + angularfudgefactor)*Math.PI/180))/2);
