...
public class MethodSettingEnum {
	...
	public enum MethodSetting {
		...
		Reflectivity_with_Flux_Correction_Simple_Scaling(3,"Reflectivity with Flux Correction with Simple Scaling"), 
		Reflectivity_without_Flux_Correction_Simple_Scaling(4,"Reflectivity without Flux Correction with Simple Scaling"),
