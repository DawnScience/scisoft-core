...
public class SXRDGeometricCorrections {
	...
	//
	// Dataset lorentzcor = Maths.multiply(Maths.cos(d),(Maths.sin(Maths.subtract(g,
	// a))));
	//
	// return lorentzcor;
	//
	...
	// public static Dataset polarisation (ExampleModel model, double IP, double OP)
	...
	// Dataset outplane =
	// Maths.subtract(1,(Maths.power((Maths.multiply(Maths.cos(d),Maths.sin(g))),2)));
	//
	//
	...
	//
	// Dataset polar =
	// Maths.divide(1,(Maths.add((Maths.multiply(OPdat,outplane)),(Maths.multiply(IPdat,inplane)))));
	// return polar;
	// }
	...
	// public static Dataset areacor (ExampleModel model,
	// boolean BeamCor,
	// boolean Specular,
	// double SampleSize,
	...
	// }
	//
	// else if (Math.abs((2 * (OutPlaneSlits))/Math.sin(0.001 +
	// betain.getDouble(i))) < ylimit) {
	// ylimitdat.set(Math.abs(2 * OutPlaneSlits / Math.sin(betain.getDouble(i) +
	// 0.001)),i);
	// }
	...
	//
	// for (double y = (-1* ylimitdat.getDouble(i)); y <= (ylimitdat.getDouble(i) +
	// ystep); y+=ystep) {
	// Dataset c = Maths.multiply(f_onsample(0, y, SampleSize) ,
	// f_beam(0,y*Math.sin(betain.getDouble(i)),
	// InPlaneSlits, OutPlaneSlits, BeamInPlane, BeamOutPlane));
	// y_sum = Maths.add(y_sum , c);
	// }
	//
	// area_cor.set( (Maths.divide(1, Maths.multiply(y_sum , ystep)).getObject(0)) ,
	// i);
	// }
	// }
	//
	...
	// }
	//
	// if (Math.abs(2* OutPlaneSlits / Math.sin(0.001 + betain.getDouble(i))) <
	// ylimit){
	// ylimitdat.set(Math.abs(2 * OutPlaneSlits / Math.sin(betain.getDouble(i) +
	// 0.001)),i);
	// }
	...
	// InPlaneSlits, OutPlaneSlits, BeamInPlane, BeamOutPlane)
	// * f_detector(x*c2.getDouble(i) - y*c3.getDouble(i), DetectorSlits) *
	...
	// bs_eff = f_beam(x, 0, InPlaneSlits, OutPlaneSlits, BeamInPlane,
	// BeamOutPlane);
	// com = com + bs_eff;
	// }
	// bs_eff =com;
	...
	// if (Specular = false){
	// Dataset sinbetaout =
	// Maths.multiply(Maths.cos(d),Maths.sin(Maths.subtract(g,a)));
